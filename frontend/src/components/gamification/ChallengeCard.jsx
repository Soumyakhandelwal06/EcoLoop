...
const ChallengeCard = ({ challenge, onSuccess }) => {
            ...
            >
                ...
                <div className="flex items-center justify-between mb-8">
                    <div className={`px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest flex items-center gap-2 ${
                        isDaily ? 'bg-amber-50 text-amber-600' : 'bg-purple-50 text-purple-600'
                    }`}>
                ...
                <div className="flex items-center justify-between pt-8 border-t border-gray-50">
                    ...
                    <button 
                        ...
                        className={`px-8 py-3 rounded-2xl font-black text-sm transition-all duration-300 flex items-center gap-2 active:scale-95 ${
                            challenge.is_completed 
                ...
                <div className={`absolute -bottom-10 -right-10 w-32 h-32 rounded-full blur-[60px] opacity-10 group-hover:opacity-20 transition-opacity duration-500 ${
                    isDaily ? 'bg-amber-400' : 'bg-purple-400'
                }`}></div>
            </motion.div>
        </>
    );
