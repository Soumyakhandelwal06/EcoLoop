...
const ChallengesModal = ({ isOpen, onClose }) => {
    ...
    useEffect(() => {
        if (isOpen) {
            const fetch = async () => {
                // Only show loading if we don't have challenges yet
                                ...
                                {loading ? (
                                    ...
                                    <div className="space-y-8">
                                        ...
                                        <section>
                                            ...
                                            {dailyChallenge ? (
                                                <ChallengeCard challenge={dailyChallenge} onSuccess={handleSuccess} />
                                            ) : (
                                        ...
                                        <section>
                                            ...
                                            {weeklyChallenge ? (
                                                <ChallengeCard challenge={weeklyChallenge} onSuccess={handleSuccess} />
                                            ) : (
                                                <div className="bg-white rounded-3xl p-8 text-center border-2 border-dashed border-gray-200">
