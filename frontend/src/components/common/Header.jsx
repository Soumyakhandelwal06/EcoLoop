                    ...
                    <>
                        ...
                        <Link to="/profile" className="flex items-center gap-3 group">
                            <div className="hidden lg:flex flex-col items-end">
                                <span className="text-sm font-black text-emerald-600 leading-none">{getUserRank(user)}</span>
                            </div>
                            <div className="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center border-2 border-green-500 shadow group-hover:shadow-md transition cursor-pointer" title={`${user.username} - ${getUserRank(user)}`}>
